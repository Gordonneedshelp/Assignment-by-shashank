...
"""
LOGIC:
1. Inputs the total bill, number of people, tax percentage, and tip percentage.
2. Validates that the number of people is greater than zero to avoid division by zero errors.
3. Multiplies the bill by tax percentage to get the tax amount.
4. Adds tax to the bill, then calculates the tip based on the new subtotal.
5. Divides the final total by the number of people to determine each person's share.
"""
